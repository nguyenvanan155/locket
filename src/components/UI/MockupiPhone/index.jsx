...
const MockupiPhone = () => {
  return (
    <div class="flex items-center justify-center ">
      <div class="relative w-65 h-[550px] rounded-[45px] shadow-[0_0_2px_2px_rgba(255,255,255,0.1)] border-8 border-zinc-900">
      {/* Dynamic Island */}
        <div class="absolute top-1.5 left-1/2 transform -translate-x-1/2 w-[70px] h-[20px] bg-zinc-900 rounded-full z-20"></div>
